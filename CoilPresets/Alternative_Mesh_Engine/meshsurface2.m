function [P, t] = meshsurface2(Pcenter, a, b, M, flag)
...
%   SNM 2018-2020
    ...
    for m = 1:Nodes - 1        
        ...
        if m >= 1 & m < Nodes - 1
            ...
            UnitPathVector  = UnitPathVector/norm(UnitPathVector);  
            [ptop, e]       = meshcross_section2(a, b, UnitPathVector, M, flag);  
    ...
    if ~Closed  
        ...
        [p1, tcapstart, added]  = meshfill2(pbottom, PathVector1);         
        t1                      = tcapstart;
        ...
        [p2, tcapend, ~]    = meshfill2(ptop, UnitPathVector);
        tcapend0            = tcapend;
