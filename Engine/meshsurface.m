function [P, t, normals] = meshsurface(Pcenter, x, y, direction, phi)
...
%   Copyright SNM/JGF 2022-2023
    ...
    if norm(direction)>0
        angle = correction(direction, UnitPathVector(1, :), Pcontour);
    ...
    for m = 1:Steps
        ...
        if norm(direction)>0
            ...
            angle           = correction(direction, UnitPathVector(m+1, :), ptemp-ptempmean);
